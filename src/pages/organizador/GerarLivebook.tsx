...
const GerarLivebook = () => {
  ...
  const [relacionarEvento, setRelacionarEvento] = useState(true); // Sempre true para organizador
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-4">
              ...
              {/* Checkbox removido - organizador sempre deve associar */}
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-900">
                  <strong>Atenção:</strong> Como organizador, você deve associar o livebook a um evento e palestra.
                </p>
              </div>
